...
var opCodeInfo = map[OpCode]opInfo{
	...
	BALANCE:      {"BALANCE", nil, []string{"balance of current context"}},
	...
	CALLDATACOPY: {"CALLDATALOAD", []string{"memOffset", "dataOffset", "length"}, nil},
	...
	// 0x40 range - block operations.
	BLOCKHASH:   {"BLOCKHASH", nil, []string{"hash of (previous) block"}},
	...
	// 0xf0 range.
	CREATE:       {"CREATE", []string{"value", "mem offset", "mem size", "gas"}, []string{"address or zero"}},
	...
	CREATE2:      {"CREATE", []string{"value", "mem offset", "mem size", "salt", "gas"}, []string{"address or zero"}},
