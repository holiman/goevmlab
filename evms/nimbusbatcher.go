...
// The NimbusBatchVM spins up one 'master' instance of the VM, and uses that to execute tests
type NimbusBatchVM struct {
	NimbusEVM
...
func (evm *NimbusBatchVM) GetStateRoot(path string) (root, command string, err error) {
	if evm.cmd == nil {
